  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding -x pt-28">
        ...
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm ml-1">
          Discover stylish Nike arrivals with quality comfort for your active
          life.
        </p>
          ...
          {statistics.map((stat, index) => {
            return (
              <div key={stat.label}>
                ...
                <p className="font-monsterrat text-slate-gray">{stat.label}</p>
              </div>
            );
          })}
        </div>
